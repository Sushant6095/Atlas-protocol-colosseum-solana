          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[color:var(--color-border)]">
                ...
                {error && (
                  <tr><td colSpan={7} className="px-5 py-12 text-center text-accent-danger">DeFiLlama API unavailable. Retry in a moment.</td></tr>
                )}
...
function FeatureCard({ pool }: { pool: DLPool }) {
  ...
  return (
    <motion.a
      ...
      rel="noreferrer"
      className="group relative overflow-hidden glass rounded-lg p-6 block"
    >
      <div
