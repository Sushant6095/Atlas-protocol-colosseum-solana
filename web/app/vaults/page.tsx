...
function Tile({ label, value, sub }: { label: string; value: string; sub: string }) {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="glass rounded-2xl p-5">
    ...
    >
      ...
      <div className="relative flex items-start justify-between mb-3">
        <div className="min-w-0">
          ...
          <h3 className="font-semibold leading-tight truncate">{vault.name}</h3>
        </div>
      ...
      <Link
        ...
        className="relative flex items-center justify-between text-sm rounded-xl bg-gradient-to-r from-[#7c5cff] to-[#29d3ff] text-white px-4 py-2 font-medium hover:opacity-95"
      >
